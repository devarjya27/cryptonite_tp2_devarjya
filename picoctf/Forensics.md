...
* I started off by increasing the height, which according to wikipedia is controlled by 4 bytes at an offset of 22. So I changed `32 01 00 00` to `32 04 00 00`.
