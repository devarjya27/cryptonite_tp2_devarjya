...
## My Solve
Firstly I extracted the zip file given to us then ran the `file` command on the extracted image to get any leads.
```
devarjya27@devarjya27-VirtualBox:~/Downloads$ file ukn_reality.jpg
...
```
Nothing really interesting its just a simple jpeg file. Now I viewed its metadata using `exiftool`.
```
devarjya27@devarjya27-VirtualBox:~/Downloads$ exiftool ukn_reality.jpg
ExifTool Version Number         : 12.40
File Name                       : ukn_reality.jpg
Directory                       : .
File Size                       : 2.2 MiB
File Modification Date/Time     : 2024:02:16 04:10:21+05:30
File Access Date/Time           : 2024:12:21 01:09:14+05:30
File Inode Change Date/Time     : 2024:12:21 01:09:03+05:30
...
Megapixels                      : 12.4
```
Under `Attribution URL` we get a `base64` encoded string. Decoding this we get our flag: `picoCTF{ME74D47A_HIDD3N_a6df8db8}`

# What I Learned
Nothing much as it was a straightforward challenge
...
![image](https://github.com/user-attachments/assets/971d21f9-bb3c-40d4-8c11-eba709d4a20f)
...
![image](https://github.com/user-attachments/assets/9dcb4cc0-d1da-4f85-88f5-6c726495ed8a)

Now extracting this and searching for `pico` we get our flag.

![image](https://github.com/user-attachments/assets/31339b8c-9a10-462d-a097-dcbadf4e11e7)
